...
#ifndef JSONRPC_CPP_STUB_EBLA_NET_ETHFACE_H_
#define JSONRPC_CPP_STUB_EBLA_NET_ETHFACE_H_
 ...
 public:
  EthFace() {
    ...
    this->bindAndAddMethod(jsonrpc::Procedure("eth_getBalance", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING,
                           ...
                           &ebla::net::EthFace::eth_getBalanceI);
    this->bindAndAddMethod(
    ...
    this->bindAndAddMethod(
        ...
        &ebla::net::EthFace::eth_getTransactionCountI);
    this->bindAndAddMethod(jsonrpc::Procedure("eth_getBlockTransactionCountByHash", jsonrpc::PARAMS_BY_POSITION,
                           ...
                           &ebla::net::EthFace::eth_getBlockTransactionCountByHashI);
    ...
    this->bindAndAddMethod(jsonrpc::Procedure("eth_getBlockByHash", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT,
                           ...
                           &ebla::net::EthFace::eth_getBlockByHashI);
    ...
    this->bindAndAddMethod(
        ...
        &ebla::net::EthFace::eth_getTransactionByBlockHashAndIndexI);
  ...
  inline virtual void eth_feeHistoryI(const Json::Value &request, Json::Value &response) {
    response = this->eth_feeHistory(request[0u], request[1u], request[2u]);
  }
  ...
  virtual Json::Value eth_feeHistory(const Json::Value &param1, const Json::Value &param2,
                                     const Json::Value &param3) = 0;
};

}  // namespace net
}  // namespace ebla
#endif  // JSONRPC_CPP_STUB_EBLA_NET_ETHFACE_H_
