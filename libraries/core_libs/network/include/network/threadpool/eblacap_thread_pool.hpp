...
class PacketsThreadPool {
 public:
   ...
   **/
  std::optional<uint64_t> push(std::pair<eblacap::EblacapVersion, PacketData>&& packet_data);
   ...
   */
  void setPacketsHandlers(eblacap::EblacapVersion eblacap_version,
 ...
 private:
  ...
  std::unordered_map<eblacap::EblacapVersion, std::shared_ptr<eblacap::PacketsHandler>> packets_handlers_;
