...
#include "network/eblacap/stats/max_stats.hpp"
#include "network/eblacap/stats/packets_stats.hpp"
...
class TimePeriodPacketsStats {
 public:
   ...
   */
  void processStats(const std::vector<std::shared_ptr<EblaPeer>>& all_peers);
