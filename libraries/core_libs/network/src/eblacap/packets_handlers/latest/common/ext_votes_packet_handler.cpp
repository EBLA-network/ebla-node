#include "network/eblacap/packets_handlers/latest/common/ext_votes_packet_handler.hpp"

#include "network/eblacap/packets/latest/get_next_votes_bundle_packet.hpp"
